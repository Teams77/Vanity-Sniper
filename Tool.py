...
async def main():##By Team-77
    os.system("cls" if os.name == "nt" else "clear")##By Team-77
    async with aiohttp.ClientSession(headers={"Authorization": token, "X-Audit-Log-Reason": "By Team77"}, connector=None) as session: #اذا مش = حط ناقص
            ...
            for vanity in list:##By Team-77
                ...
                if idk == 404:##By Team-77
                    ...
                    if idk2 in (200, 201, 204):##By Team-77
                        ...
                        await notify(session, hook, {"content": "**failed to claim %s **\n\n@everyone" % (vanity)})##By Team-77
                        sys.exit()##By Team-77
                elif idk == 200:##By Team-77
                    print(Fore.GREEN + "By Team77 Sniping: {%s}" % (vanity))##By Team-77
##By Team-77
##By Team-77
...
##By Team-77
##By Team-77
loop = asyncio.get_event_loop()##By Team-77##By Team-77
